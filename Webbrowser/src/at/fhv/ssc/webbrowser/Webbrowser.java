...
public class Webbrowser {
    ...
    //eins noch, jetzt kann man bei dir halt ned einfach nur apache.org eingeben, das würd ne exception werfen :D

    //bzw kann ein document mehrere / behinhalten, falls später noch lust hast das einzubauen :D
    ...
    private void urlIntoHost(String url) {
        ...
        if (url.indexOf("/") == -1) {
            ...
            _document = url.substring(url.indexOf("/" + 1));
