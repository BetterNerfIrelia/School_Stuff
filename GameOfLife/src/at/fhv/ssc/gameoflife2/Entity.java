...
public class Entity {
    ...
    public Entity createRandomEntity() {                        //creates a Entity with 50% chance of being alive.
    ...
    public Entity[][] createEntityMatrix(int x, int y) {        //creates a matrix filled with entities.
